...
class ExampleReflex < ApplicationReflex
  ...
  def change
    ...
    morph "#main_container", "Hello there #{ current_user.handle }"
  end
  ...
  def new_object_view
    ...
    morph :nothing
    # morph "#main_container", render( partial: element.dataset["partial_path"], locals: { element.dataset["model"]: object } )
  end
